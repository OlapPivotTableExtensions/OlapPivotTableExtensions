...
namespace CustomActions
{
    ...
    {
        private static string[] REGISTRY_PATHS = new string[] { @"Software\Microsoft\Office\12.0\Excel\Resiliency\DisabledItems"
                                                              , @"Software\Microsoft\Office\14.0\Excel\Resiliency\DisabledItems"};
